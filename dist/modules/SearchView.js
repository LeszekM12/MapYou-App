                ...
                import('./HomeView.js').then((hv) => {
                    ...
                    data.data.forEach(f => {
                        ...
                        if (f.kind === 'post' && d.type === 'club_event') {
                            ...
                            ev.innerHTML = `<span style="color:rgba(255,255,255,0.4)">${d.title}</span><span style="color:rgba(255,255,255,0.25);margin-left:8px;font-size:1.1rem">${new Date(f.date).toLocaleDateString('en', { month: 'short', day: 'numeric' })}</span>`;
