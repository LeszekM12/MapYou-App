...
export class FeedRecycler {
    constructor() {
        ...
        Object.defineProperty(this, "zdjete", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        }); // miejsce → karta
        Object.defineProperty(this, "liczbaZdjetych", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    zdejmij(karta) {
        ...
        if (karta.dataset.recyklerMiejsce === '1')
            return;
        if (!karta.isConnected || !karta.parentElement)
            return;
    ...
    przywroc(miejsce) {
        if (miejsce.dataset.recyklerMiejsce !== '1')
            return;
        const wpis = this.zdjete.get(miejsce);
        if (!wpis || !miejsce.parentElement)
            return;
    ...
    get zdjetych() { return this.zdjete.size; }
}
...
//# sourceMappingURL=feedRecycler.js.map